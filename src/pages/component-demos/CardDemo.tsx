...
export default function CardDemo({ showHeader, showFooter, showDescription, variant }: CardDemoProps) {
  const hasControls = showHeader !== undefined

  if (hasControls) {
    return (
      <Card className={cn('max-w-sm', variant === 'outline' && 'shadow-none border-2')}>
        {showHeader && (
          <CardHeader>
