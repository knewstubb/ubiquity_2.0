      ...
      <div className="w-full max-w-sm space-y-1.5">
        ...
        <div
          className={cn(
            ...
            SIZE_CLASSES[size],
            isError && 'border-destructive hover:border-destructive focus-within:border-destructive focus-within:shadow-ring-destructive',
            isSuccess && 'border-success hover:border-success focus-within:border-success focus-within:shadow-ring',
    ...
    <div className="flex flex-col gap-8 w-full max-w-lg">
      ...
      <section className="flex flex-col gap-2">
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex items-center w-full rounded-md border border-input bg-background h-10 overflow-hidden focus-within:border-ring focus-within:shadow-ring">
            <input
              id="demo-default"
              type="text"
      ...
      <section className="flex flex-col gap-2">
        ...
        <div className="space-y-3">
          <div className="flex items-center w-full rounded-md border border-input bg-background h-8 overflow-hidden focus-within:border-ring focus-within:shadow-ring">
          ...
          <div className="flex items-center w-full rounded-md border border-input bg-background h-12 overflow-hidden focus-within:border-ring focus-within:shadow-ring">
