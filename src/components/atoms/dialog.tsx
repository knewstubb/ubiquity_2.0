 ...
 * - bg-background: modals use page background colour since the dark overlay + blur
 *   already provides visual separation; they don't need "elevated" white surfaces
