...
import type {
  ...
  SubSourceConfig,
  FilterFieldDef,
} from '../../organisms/filter-builder/types'
import { getOperatorsForType } from '../../organisms/filter-builder/operators'
import { NO_VALUE_OPERATORS, ARRAY_VALUE_OPERATORS } from '../../organisms/filter-builder/operators'
