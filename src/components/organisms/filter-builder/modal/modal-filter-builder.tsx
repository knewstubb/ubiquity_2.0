...
export function ModalFilterBuilder({
  ...
  if (sourceCategories.length === 0) {
    return (
      <div data-component="organisms/ModalFilterBuilder" className="rounded-md border border-border p-6">
  ...
  if (value.conditions.length === 0 && !inProgressCard) {
    return (
      <div data-component="organisms/ModalFilterBuilder" className="flex-1 flex flex-col items-center gap-4">
  ...
  if (value.conditions.length === 0 && inProgressCard) {
    return (
      <div data-component="organisms/ModalFilterBuilder" className={compact ? "" : "rounded-lg p-6"}>
        <InlineConditionCard
