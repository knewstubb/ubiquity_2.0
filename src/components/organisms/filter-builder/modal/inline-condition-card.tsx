...
export function InlineConditionCard({
  ...
  return (
    <div ref={cardRef} data-component="organisms/InlineConditionCard" className={cn("rounded-lg border border-primary bg-card shadow-md overflow-visible", compact ? "p-2" : "p-4")}>
