...
export function SectionDivider({ label, variant = 'line', className }: SectionDividerProps) {
  if (variant === 'heading') {
    return (
      <div data-component="molecules/SectionDivider" className={cn("border-b border-border pb-2 mb-[-16px]", className)}>
  ...
  return (
    <div data-component="molecules/SectionDivider" className={cn("flex items-center gap-3 mb-[-16px]", className)}>
