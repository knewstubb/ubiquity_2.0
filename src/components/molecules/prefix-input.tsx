...
const PrefixInput = React.forwardRef<HTMLInputElement, PrefixInputProps>(
  ({ prefix, className, ...props }, ref) => {
    return (
      <div data-component="molecules/PrefixInput" className="flex h-9 border border-input rounded-md overflow-hidden focus-within:border-ring focus-within:shadow-ring">
