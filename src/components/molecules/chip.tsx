...
export function Chip({
  ...
  if (onClick) {
    return (
      <button type="button" data-component="molecules/Chip" className={classes} onClick={onClick} disabled={disabled}>
        {content}
      </button>
    )
  }

  return <span data-component="molecules/Chip" className={classes}>{content}</span>
}
