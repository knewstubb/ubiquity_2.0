    ...
    <div className="flex flex-col gap-6" data-testid="data-type-step">
      ...
      <div className="flex flex-col gap-2">
        ...
        <input
          id="connector-name"
          type="text"
          className="w-full py-2 px-3 text-sm font-normal text-foreground bg-background border border-border rounded-md leading-5 transition-all duration-150 placeholder:text-tertiary-foreground hover:border-tertiary-foreground focus:outline-none focus:border-ring focus:shadow-ring"
