...
export function MessagesFilterPanel({ config, onChange, channel }: MessagesFilterPanelProps) {
  ...
  const filteredCampaigns = campaignsForChannel.filter((c) =>
  ...
  function handleFilterTypeChange(type: MessagesFilterType) {
    ...
    // Reset secondary inputs when changing filter type
  ...
  return (
    <div className="flex flex-col gap-3" data-testid="messages-filter-panel">
      {/* Filter type radio options */}
      <div className="flex flex-col gap-2" role="radiogroup" aria-label="Message filter type">
      ...
      {/* Secondary inputs based on selected filter type */}
      {config.type === 'by_status' && (
        ...
        <div className="bg-muted rounded-lg p-4 flex flex-col gap-3">
          ...
          {campaignsForChannel.length === 0 ? (
            ...
            <>
              ...
              >
                <SelectTrigger aria-label="Select campaign">
      ...
      {config.type === 'in_date_range' && (
        <div className="bg-muted rounded-lg p-4 flex flex-col gap-3">
          <div className="flex flex-col gap-2">
            <Label htmlFor="messages-start-date" className="text-xs font-medium">
              Start date
            </Label>
            <Input
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="messages-end-date" className="text-xs font-medium">
              End date
            </Label>
            <Input
