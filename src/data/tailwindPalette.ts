/**
 * Full Tailwind v4 colour palette lookup table + custom mint palette.
 * Used by the Token Manager to resolve primitive references (e.g. "zinc-800")
 * to their hex values for CSS injection.
 */
...
export const tailwindPalette: Record<string, Record<string, string>> = {
  ...
  // Custom UDS brand palette (from globals.css)
  mint: {
