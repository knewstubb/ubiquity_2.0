...
export const componentRegistry: ComponentEntry[] = [
  ...
  },
  {
    ...
    designGuidance: [
      ...
      { heading: 'States', content: [
        'Empty: Flex-fill top-biased layout (flex spacer at 25% height, justify-start) with Funnel icon + descriptive text + auto-width dashed-border "Add your first condition" CTA. Positioned in upper third rather than dead-centre for a more natural feel in tall panels. No logic group chrome until first condition exists.',
