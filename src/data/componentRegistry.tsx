...
export const componentRegistry: ComponentEntry[] = [
  ...
  },
  {
    ...
    designGuidance: [
      ...
      { heading: 'States', content: [
        'Empty: Root logic group with only +Filter action visible.',
        ...
        'OR groups: Purple-500 toggle pill and left border connector — distinct colour signals alternative logic at a glance.',
