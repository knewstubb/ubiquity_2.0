  ...
  },
  {
    ...
    designGuidance: [
      ...
      { heading: 'Container styling', content: [
        ...
        'Inline variant: bordered container with internal padding.',
      ]},
    ],
    propControls: [
      ...
      { name: 'field-set', label: 'Field Set', controlType: 'select', defaultValue: 'all-types', options: [
        { label: 'All Types (demo)', value: 'all-types' },
        { label: 'Contacts (system fields)', value: 'contacts' },
        { label: 'Messages (mailout fields)', value: 'messages' },
        { label: 'Source Categories (hierarchical)', value: 'source-categories' },
      ], visibleWhen: { controlName: 'variant', values: ['inline'] } },
